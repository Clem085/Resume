...
\begin{resumebullets}
  ...
  \item Created and maintained a 17,000+ entry tooling where-used list for the entire plant, linking each tool to part numbers, operation numbers, storage locations, and vendors with custom lookup formulas and data-validation rules.
\end{resumebullets}
