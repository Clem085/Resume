...
\hypersetup{
  ...
  pdfkeywords={embedded firmware, C, C++, Embedded Linux, Yocto, Arago, Linux kernel, device tree, systemd, Docker, DSP, PIC32, CAN, firmware update, power conversion, BMS}
}
...
Embedded firmware engineer with experience in TI Embedded Linux platforms, a multi-controller firmware-update workflow, programmable power-conversion control, and CAN-connected battery systems. Experienced across C/C++, Linux services, board bring-up, bench debugging, and cross-platform Windows/Linux tooling.
...
\textbf{Processors \& Interfaces:} TI AM62, TI TMS320 DSP, PIC32, MSP430FR2355; CAN/CAN FD/J1939, I2C, SPI, UART/RS-232, ADC, PWM, GPIO, IPMI/IPMB\\
...
\begin{resumebullets}
  \item Built an Excel/VBA tolerance checker for manufactured parts and organized a searchable 17,000+ record catalog connecting tooling, parts, vendors, operations, locations, and revisions.
\end{resumebullets}

\section{Senior Design}
\resumeentry{EV Active Sensor Adapter | MSP430FR2355}{NC State University}
\begin{resumebullets}
  \item Defined end-to-end architecture, requirements, interface specifications, risks, and validation plans for sensing, BMS and power-management hardware, custom-PCB interfaces, embedded control, communications, and telemetry; coordinated decisions and documentation across the team.
  \item Evaluated BMS/support ICs against electrical, protocol, package, and sourcing constraints using datasheets and reference designs; translated selections into integration plans, prototyped interrupt-driven SPI, and worked with ADC, UART, timer, GPIO, and LCD interfaces.
\end{resumebullets}

\section{Teaching \& Technical Leadership}
\resumeentry{ECE 306 Embedded Systems Instruction | NC State University}{Spring 2025--Spring 2026}
\begin{resumebullets}
  \item Supported three semesters: two in an unofficial role at about 10 hr/week and one as the official TA at 20 hr/week; delivered supplemental lectures, test preparation, labs, code/PCB debugging, project guidance, and ECE-program support.
  \item Added supplemental lectures and intensive, question-driven support as the class average rose from its typical C+ to A-.
\end{resumebullets}
