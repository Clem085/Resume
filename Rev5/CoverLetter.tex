...
\newcommand{\LetterDate}{August 10, 2026}
...
Separately, my BMS experience comes from my NC State senior design project. I helped define the architecture and requirements, specify interfaces, track risks, and plan validation. The system spanned sensing, BMS and power hardware, MSP430 firmware, custom PCB interfaces, communications, and telemetry. I evaluated candidate ICs and translated component trade studies into firmware and hardware integration plans while coordinating design decisions and documentation with the team.

Teaching has strengthened the same skills. I supported ECE 306 for three semesters: two in an unofficial teaching support role and one as the official teaching assistant. I delivered supplemental lectures, led laboratories, debugged code and PCBs, guided projects, and supported students. I also led two semesters of IEEE Open Project Space 2 and separately coordinated and taught through-hole and surface-mount soldering workshops. Guiding students to find their own root causes has made me a more methodical debugger and a clearer engineering teammate.
