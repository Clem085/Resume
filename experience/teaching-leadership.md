...
- Delivered supplemental lectures, test preparation, embedded-systems theory, and practical laboratory instruction.
- Explained C, MSP430 firmware, ADC acquisition, PWM, timers, interrupts, GPIO, LCD integration, serial diagnostics, and custom-PCB bring-up.
- Translated register-level and timing concepts into practical steps that students could apply to their own implementations.

### Debugging and project support

- Diagnosed code, peripheral configuration, wiring, soldering, debugger/toolchain, and board-level problems across diverse student designs.
- Used datasheets, serial output, measurements, register/debugger state, isolated tests, and controlled substitutions to teach systematic fault isolation.
- Helped reconcile schematic pin assignments, physical wiring, firmware configuration, and soldered hardware during project integration.
- Provided laboratory help, code review/debugging, project advice, course strategy, and ECE academic/career guidance.
...
- Was recommended by a college mathematics instructor for a paid tutoring position.
- Tutored high-school and community-college students in pre-calculus, statistics, and quantitative literacy.
- Supported remote and in-person students and adapted explanations to different levels of preparation and learning style.
- Used verbal walkthroughs, written/visual steps, and repeated examples to help students reach an independent understanding.
- Archived accounts describe approximately ten paid hours per week and, in some résumé versions, two to three hours of support per day; use no exact workload metric until reconciled.

## Earlier Tutoring and STEM Mentoring

- Provided extensive volunteer mathematics tutoring during high school before moving into the paid college role; archived logs record 250 hours in sophomore year, 120 in junior year, and 90 in senior year before paid hours stopped being counted.
- Mentored a middle-school student through Big Brothers Big Sisters using robots, coding interfaces, and a different learning activity each week.
- Presented to TEAM Industries leadership and local teachers about student involvement in STEM and the value of school/industry partnerships.
- Helped younger students through church and community programs, including one-on-one work with children who needed additional behavioral or instructional support.

## Earlier Technical Leadership

- Served as co-captain of a high-school STEM/Robotics team, helping guide robot design, assembly, and programming; the team placed third in a regional competition.
- Was a founding member of a coding club that worked through an advanced Harvard programming curriculum.
- Served as senior-class vice president and INTERACT vice president, gaining early experience representing peers, organizing service work, and communicating with community partners.
