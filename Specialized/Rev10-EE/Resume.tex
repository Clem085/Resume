...
\textbf{Embedded firmware} engineer and \textbf{NCSU computer engineering} graduate. Four internships and full-time experience spanning embedded systems, electrical engineering, and manufacturing automation. Experienced in system-level troubleshooting across hardware, firmware, and software. Developed C/C++ firmware, test automation tools, and manufacturing databases.
...
\begin{resumebullets}
  ...
  \item Support firmware development, hardware integration, and documentation for VPX/IPMI power systems, TI AM62 Embedded Linux controllers; troubleshoot Yocto/Arago images, device trees, boot issues, CAN power devices, and watchdogs.
\end{resumebullets}
...
\begin{resumebullets}
  \item Built a configurable validation and duplicate-detection system for a 17,000+ record plant-wide tooling database, allowing users to select comparison criteria while automatically identifying, locating, and highlighting duplicate or inconsistent manufacturing records.
...
\begin{resumebullets}
  \item Developed an object-oriented C++ maze-solving application using reusable classes, dynamic data structures, and multiple search strategies; debugged and compared implementations for correctness, memory use, and execution performance.
\end{resumebullets}

\resumeentry{C++ Microarchitecture Simulators}{NC State University}
\begin{resumebullets}
  \item Developed modular C++ simulators for cpu processor subsystems using classes and objects to model system state, component interactions, and configurable behavior; validated results across multiple test configurations.
\end{resumebullets}
