...
\begin{resumebullets}
  \item Developed SQL/VBA automation with Microsoft Access and Excel for an Acceptance Test Procedure (ATP) database, parsing and validating test data, retrieving historical records, and automating database entry.
