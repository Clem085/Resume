...
\textbf{Embedded firmware engineer and computer engineering graduate} with four internships spanning electrical systems and manufacturing. Developed C/C++ firmware, production tools, manufacturing databases, and plant-wide tooling records.

\section{Skills}
\textbf{Programming \& Data:} C, C++, SQL, VBA, Microsoft Access, Excel, Python, MATLAB, Bash\\
\textbf{Embedded \& Controls:} STM32G474, dsPIC33CK, PIC32, TI C2000/TMS320, MSP430FR2355; bare-metal firmware, FreeRTOS, Embedded Linux, ADC sensing, PWM motor control, timers\\
\textbf{Interfaces:} CAN 2.0, CAN FD, J1939, I2C, SPI, UART/RS-232, GPIO\\
\textbf{Hardware \& Manufacturing:} Schematic interpretation; PCB review in Altium, KiCad, and P-CAD; JTAG, oscilloscopes, logic/protocol analyzers; production programming, test automation, tooling data

\section{Experience}
\resumeentry{AEGIS Power Systems | Embedded Firmware Engineer}{May 2026--Present}
\begin{resumebullets}
  \item Wrote and debugged C firmware for dsPIC33CK-based power hardware, including CAN, ADC, PWM, I2C, SPI, UART, and timers; verified electrical signals and bus traffic with JTAG, oscilloscopes, and logic analyzers.
...
\begin{resumebullets}
  \item Wrote STM32G474 firmware for a custom EV sensor board that read ten ADC thermistors, exchanged CRC-checked cell and fault data with a BQ79616 over UART, and transmitted measurements over CAN.
\end{resumebullets}
