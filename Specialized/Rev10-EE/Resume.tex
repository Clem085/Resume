...
\textbf{Embedded firmware engineer and NCSU computer engineering graduate}. Four internships and full time experience spanning embedded systems, electrical engineering, and manufacturing automation. Experienced in system-level troubleshooting across hardware, firmware, and software. Developed C/C++ firmware, test automation tools, and manufacturing database.

\section{Skills}
\textbf{Programming \& Data:} C, C++, SQL, VBA, Microsoft Access, Excel, Python, MATLAB, Bash\\
\textbf{Architectures:} STM32, dsPIC33, PIC32, TI C2000, MSP430; bare-metal firmware, FreeRTOS, Embedded Linux\\
\textbf{Peripherals:} GPIO, DAC Control, ADC sensing and filtering, PWM control, timers, interrupts, and embedded communications\\
\textbf{Interfaces:} CAN 2.0, CAN FD, Drone CAN, J1939, I2C, IPMI, SPI, UART/RS-232, Ethernet, TCP/IP\\
...
\begin{resumebullets}
  \item Wrote and debugged C firmware for dsPIC33 hardware, including CAN, ADC, PWM, I2C, SPI, UART, and timers; verified electrical signals and bus traffic with JTAG, oscilloscopes, and logic analyzers.
  \item Used schematics and PCB layouts from Altium, KiCad, and P-CAD to trace system failures across wiring, power, firmware, CAN traffic, device settings, Linux services, and application software.
  \item Integrated CAN-connected power devices with a TI AM62 Embedded Linux controller, including Yocto/Arago images, Linux kernels, device trees, boot troubleshooting, and an external-watchdog service.
\end{resumebullets}
